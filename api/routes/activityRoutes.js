...
activityRouter.post("/comments", ()=>requireAuth(), activityController.createNewComment);
activityRouter.delete("/comments/:id", ()=>requireAuth(), activityController.deleteComment);
